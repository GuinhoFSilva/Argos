...
public class PlayerFactory {
    public static Player createValidPlayer() {
        return Player.reconstitute(UUID.randomUUID(), Nickname.of("nickname"), Email.of("email@test.com"), PasswordHash.of("hashed-password"), Role.of("PLAYER"), LocalDateTime.now(), LocalDateTime.now());
    }

    public static Player reconstituteValidPlayer(UUID id) {
        return Player.reconstitute(id, Nickname.of("nickname"), Email.of("email@test.com"), PasswordHash.of("hashed-password"), Role.of("PLAYER"), LocalDateTime.now(), LocalDateTime.now());
